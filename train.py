...
if __name__ == '__main__':
    ...
    for episode in range(1):
        ...
        modelSavePath = os.path.join("model", "PPO_{}_{}.pth".format(env_name, episode))
        for step in range(6000):
            ...
            if len(ppo_agent.buffer.rewards) >= param.updateNum:
                output_csv_path = os.path.join(log_dir, f"{env_name}_episode{episode}.csv")
